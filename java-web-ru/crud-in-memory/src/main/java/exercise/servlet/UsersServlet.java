...
public class UsersServlet extends HttpServlet {
    ...
    private void updateUser(HttpServletRequest request,
        ...
        inputUser.put("id", id);
        inputUser.put("firstName", inputFirstName);
        inputUser.put("lastName", inputLastName);
        ...
        user.put("firstName", inputFirstName);
        user.put("lastName", inputLastName);
        user.put("email", inputEmail);
        String path = "/users/show?id=" + id;
